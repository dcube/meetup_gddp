...
ALTER TASK IF EXISTS &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_LINEITEM SUSPEND;
ALTER TASK IF EXISTS &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_ORDERS SUSPEND;
ALTER TASK IF EXISTS &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_PARTSUPP SUSPEND;
ALTER TASK IF EXISTS &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_CUSTOMER SUSPEND;
ALTER TASK IF EXISTS &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_PART SUSPEND;
ALTER TASK IF EXISTS &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_SUPPLIER SUSPEND;
ALTER TASK IF EXISTS &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_NATION SUSPEND;
ALTER TASK IF EXISTS &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_REGION SUSPEND;
...
CREATE OR ALTER TASK &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_ENTRYPOINT
  WAREHOUSE=LOAD
  AS
  SELECT 'dummy'
  ;
...
-- task to load region
CREATE OR ALTER TASK &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_REGION
  WAREHOUSE=LOAD
...
CREATE OR ALTER TASK &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_NATION
  WAREHOUSE=LOAD
  AFTER &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_ENTRYPOINT
  AS
...
CREATE OR ALTER TASK &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_SUPPLIER
  WAREHOUSE=LOAD
  AFTER &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_ENTRYPOINT
  AS
...
CREATE OR ALTER TASK &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_PART
  WAREHOUSE=LOAD
  AFTER &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_ENTRYPOINT
  AS
...
CREATE OR ALTER TASK &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_CUSTOMER
  WAREHOUSE=LOAD
  AFTER &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_ENTRYPOINT
  AS
...
CREATE OR ALTER TASK &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_PARTSUPP
  WAREHOUSE=LOAD
  AFTER &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_ENTRYPOINT
  AS
...
CREATE OR ALTER TASK &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_ORDERS
  WAREHOUSE=LOAD
  AFTER &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_ENTRYPOINT
  AS
...
CREATE OR ALTER TASK &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_LINEITEM
  WAREHOUSE=LOAD
  AFTER &{data_domain}.TPCH_SF100.LOAD_RAW_DATA_ENTRYPOINT
  AS
