...
-- WAREHOUSE LOAD
CREATE OR ALTER WAREHOUSE LOAD WAREHOUSE_SIZE = 'XSMALL',
MAX_CLUSTER_COUNT = 1,
AUTO_SUSPEND = 60,
AUTO_RESUME = TRUE,
INITIALLY_SUSPENDED = TRUE;
...
-- WAREHOUSE ANALYSIS
CREATE OR ALTER WAREHOUSE ANALYSIS WAREHOUSE_SIZE = 'XSMALL',
MAX_CLUSTER_COUNT = 1,
AUTO_SUSPEND = 60,
AUTO_RESUME = TRUE,
INITIALLY_SUSPENDED = TRUE;
...
-- COMPUTE POOL
/*
CREATE COMPUTE POOL IF NOT EXISTS COMPUTE_POOL_XS
  MIN_NODES = 1
  MAX_NODES = 1
...
GRANT USAGE ON WAREHOUSE MANAGE TO ROLE SECURITYADMIN;
