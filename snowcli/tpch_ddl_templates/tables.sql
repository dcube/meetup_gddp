...
{% for schema in schemas %}
    ...
    BASE_LOCATION = '{{ schema }}/TPCH_SF100_ICEBERG/CUSTOMER'
    {% endif %}
    ;
    ...
    CATALOG = 'SNOWFLAKE'
    EXTERNAL_VOLUME = '{{ domain }}_S3_LAKEHOUSE'
    BASE_LOCATION = '{{ schema }}/TPCH_SF100_ICEBERG/LINEITEM'
    {% endif %}
    ;
    ...
    CATALOG = 'SNOWFLAKE'
    EXTERNAL_VOLUME = '{{ domain }}_S3_LAKEHOUSE'
    BASE_LOCATION = '{{ schema }}/TPCH_SF100_ICEBERG/NATION'
    {% endif %}
    ;
    ...
    CATALOG = 'SNOWFLAKE'
    EXTERNAL_VOLUME = '{{ domain }}_S3_LAKEHOUSE'
    BASE_LOCATION = '{{ schema }}/TPCH_SF100_ICEBERG/ORDERS'
    {% endif %}
    ;
    ...
    CATALOG = 'SNOWFLAKE'
    EXTERNAL_VOLUME = '{{ domain }}_S3_LAKEHOUSE'
    BASE_LOCATION = '{{ schema }}/TPCH_SF100_ICEBERG/PARTSUPP'
    {% endif %}
    ;
    ...
    CATALOG = 'SNOWFLAKE'
    EXTERNAL_VOLUME = '{{ domain }}_S3_LAKEHOUSE'
    BASE_LOCATION = '{{ schema }}/TPCH_SF100_ICEBERG/PART'
    {% endif %}
    ;
    ...
    CATALOG = 'SNOWFLAKE'
    EXTERNAL_VOLUME = '{{ domain }}_S3_LAKEHOUSE'
    BASE_LOCATION = '{{ schema }}/TPCH_SF100_ICEBERG/REGION'
    {% endif %}
    ;
    ...
    CATALOG = 'SNOWFLAKE'
    EXTERNAL_VOLUME = '{{ domain }}_S3_LAKEHOUSE'
    BASE_LOCATION = '{{ schema }}/TPCH_SF100_ICEBERG/SUPPLIER'
    {% endif %}
    ;
